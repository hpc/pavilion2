...
class _RunCommand(Command):
    ...
    def run(self, pav_cfg, args):
        ...
        try:
            ...
            fprint(None, "Error loading test '{}': {}".format(args.test_id, err))
            raise
        ...
        try:
            ...
            if var_man.get('sched.errors'):
                ...
                fprint(None, "Error resolving scheduler variables at run time. Got "
                             "the following:")
            ...
            try:
                if not test.build_local:
                    if not test.build():
                        fprint(None, "Test {} failed to build.".format(test.full_id))
    ...
    def _run(self, test: TestRun):
        ...
        try:
            ...
            fprint(None, "Unexpected error gathering results: \n{}", traceback.format_exc())
