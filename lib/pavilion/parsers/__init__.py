...
BAD_EXAMPLES = [
    ...
    ErrorCat('Hanging Operation', ['{{a+}}', '{{a*}}', '{{a^}}', '{{a<}}',
                                   '{{a or}}', '{{a and}}', '{{not}}']),
    ErrorCat('List indexes and slices must contain a value', ['a[]', 'funky()[]']),
    ErrorCat('Unmatched "]"', ['{{a]}}', '{{a:1]}}', 'funky()]', 'funky():]', 'funky()3]']),
    ErrorCat('Unmatched "("', ['{{(a+b}}', '{{funky(}}', '{{funky(a}}']),
    ErrorCat('Unmatched "["', ['{{a[}}', '{{a[1}}', '{{a[1:}}', '{{a[1:2}}']),
    ErrorCat('Extra colon in slice', ['{{a[1:2:3]}}', '{{a[1:2:3:4:5]}}',
                                      '{{a[1:2:]}}']),
