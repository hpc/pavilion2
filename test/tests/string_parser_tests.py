...
class TestStringParser(unittest.TestCase):
    ...
    def test_parser(self):
        """Check string parsing and variable substitution. Permutations are handled at a higher
        level, so there's really only a few things to check here."""
