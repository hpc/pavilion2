...
def test_structure(data_filename, structure_filename, verbose=False):
    ...
    try:
        ...
        if verbose:
            print("NODES1:")  # ext-print: ignore
            pprint.pprint(nodes1)  # ext-print: ignore
            print("NODES2:")  # ext-print: ignore
            pprint.pprint(nodes2)  # ext-print: ignore
...
def test_parser(data_filename, canonical_filename, verbose=False):
    ...
    try:
        ...
        if verbose:
            print("EVENTS1:")  # ext-print: ignore
            pprint.pprint(events1)  # ext-print: ignore
            print("EVENTS2:")  # ext-print: ignore
            pprint.pprint(events2)  # ext-print: ignore
...
def test_constructor(data_filename, canonical_filename, verbose=False):
    ...
    try:
        ...
        if verbose:
            print("NATIVE1:")  # ext-print: ignore
            pprint.pprint(native1)  # ext-print: ignore
            print("NATIVE2:")  # ext-print: ignore
            pprint.pprint(native2)  # ext-print: ignore
